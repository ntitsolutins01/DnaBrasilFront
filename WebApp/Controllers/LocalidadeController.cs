...
namespace WebApp.Controllers
{
    ...
    public class LocalidadeController : BaseController
    {
        ...
        public LocalidadeController(IOptions<UrlSettings> appSettings, ILog logger)
        {
            _logger = logger;
        ...
        public IActionResult Index(int? crud, int? notify, string message = null)
        {
            ...
            try
            {
                _logger.Info($"Usuario Logado em Localidade.Index User.Identity.Name : {User.Identity.Name}");
            ...
            {
                _logger.Error($"Localidade.Index: {e.StackTrace}");
