                ...
                Highcharts.chart('containerSaudePercentual', {
                    ...
                    series: [{
                        ...
                        data: [{
                            ...
                            y: result.data.dashboard.listTotalizadorSaudeSexo.percentualSaude.ABAIXODONORMAL,
                            z: 50
                        }, {
                            name: 'NORMAL',
                            y: result.data.dashboard.listTotalizadorSaudeSexo.percentualSaude.NORMAL,
                            z: 50
                        }, {
                            name: 'SOBREPESO',
                            y: result.data.dashboard.listTotalizadorSaudeSexo.percentualSaude.SOBREPESO,
                            z: 50
                        }, {
                            name: 'OBESIDADE',
                            y: result.data.dashboard.listTotalizadorSaudeSexo.percentualSaude.OBESIDADE,
                            z: 50
                        }],
                        colors: [
                            '#EF5350',
